...
function Navigation() {
  ...
  return (
    <div className='h-' >
      ...
      <div id="Main" className={`${show ? "-translate-x-full" : "translate-x-0"} bg-white transform  xl:translate-x-0 ease-in-out transition duration-500 flex justify-center items-start w-full sm:w-72   flex-col h-full`}>
        ...
        <div className="xl:mt-6 flex flex-col justify-start items-start  px-4 w-full space-y-3 pb-5   ">
          ...
          <button className="focus:outline-noneflex justify-center  hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4 items-center space-x-6 w-full ">
            <p className="text-base leading-4 ">Dashboard</p>
          </button>
          <button className="focus:outline-noneflex justify-center  hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4  items-center w-full  space-x-6" onClick={product}> 
            <p className="text-base leading-4 ">Addproduct</p>
          </button>
          <button className="focus:outline-noneflex justify-center  hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4  items-center w-full  space-x-6" onClick={productdelete}> 
            <p className="text-base leading-4 ">productDetails</p>
          </button>
          <button className="focus:outline-none flex justify-center  items-center space-x-6 hover:text-white focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded  py-3 pl-4  w-full " onClick={Users} >
            <p className="text-base leading-4  ">Users</p>
          </button>
          <button className="flex justify-center items-center space-x-6 hover:text-white focus:outline-none focus:bg-indigo-700 focus:text-white hover:bg-indigo-700 text-gray-600 rounded py-3 pl-4  w-full" onClick={Category}>
