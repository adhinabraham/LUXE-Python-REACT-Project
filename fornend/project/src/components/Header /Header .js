          ...
          <div className="flex items-center justify-between border-b border-gray-200 dark:border-gray-700 py-4">
              ...
              <div className="hidden md:block">
                  <ul className="flex items-center space-x-6">
                      <li>
                          <button  className="dark:text-white border-none dark:hover:text-gray-300 text-base text-right text-gray-800 focus:outline-none  hover:underline" onClick={()=>{navigate('/')}}>
                              {" "}
                              Home{" "}
                          </button>
                      </li>
                      <li>{cookie['mytoken']?
                          <button  className="dark:text-white border-none dark:hover:text-gray-300 text-base text-right text-gray-800 focus:outline-none  hover:underline" onClick={()=>{navigate('/')}}>
                           ...
                           <button  className="dark:text-white border-none dark:hover:text-gray-300 text-base text-right text-gray-800 focus:outline-none  hover:underline" onClick={()=>{navigate('/siginup')}}>
                           {" "}
                           siginup{" "}
                       </button>}
                      ...
                      <li>
                          {cookie['mytoken']?
                          <button className="dark:text-white border-none dark:hover:text-gray-300 text-base text-right text-gray-800 focus:outline-none  hover:underline" onClick={logout} > 
                         Logout
                          </button>:
                           <button className="dark:text-white border-none dark:hover:text-gray-300 text-base text-right text-gray-800 focus:outline-none  hover:underline" onClick={()=>{navigate('/otp')}}> 
                           Login
                            </button>}
                      </li>
                      {/* <li>
              ...
              <div className="hidden md:flex items-center space-x-4">
                  ...
                  <a aria-label="Bag" href="javascript:void(0)" className="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded">
                      <svg className="fill-stroke text-gray-800 dark:text-white" width={20} height={22} viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={()=>{navigate('/cart')}} >
                  ...
                  </a>: <a aria-label="Bag" href="javascript:void(0)" className="focus:outline-none focus:ring-2 focus:ring-gray-800 hover:bg-gray-100 p-0.5 rounded">
                      <svg className="fill-stroke text-gray-800 dark:text-white" width={20} height={22} viewBox="0 0 20 22" fill="none" xmlns="http://www.w3.org/2000/svg" onClick={()=>{navigate('/otp')}} >
                          <path d="M4 1L1 5V19C1 19.5304 1.21071 20.0391 1.58579 20.4142C1.96086 20.7893 2.46957 21 3 21H17C17.5304 21 18.0391 20.7893 18.4142 20.4142C18.7893 20.0391 19 19.5304 19 19V5L16 1H4Z" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M1 5H19" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                          <path d="M14 9C14 10.0609 13.5786 11.0783 12.8284 11.8284C12.0783 12.5786 11.0609 13 10 13C8.93913 13 7.92172 12.5786 7.17157 11.8284C6.42143 11.0783 6 10.0609 6 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                      </svg>
