...
function Showproduct() {
    ...
    useEffect(()=>{
        axios.get("http://127.0.0.1:8000/product/showproduct/"+id).then((Response)=>{
            ...
            <div className="flex justify-center items-center lg:flex-row flex-col gap-8">
                ...
                <div className="  w-full sm:w-96 md:w-8/12 lg:w-6/12 items-center">
                    {/* <p className=" focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 font-normal text-base leading-4 text-gray-600">Home / Furniture / Wooden Stool</p> */}
                          ...
                          <h2 className="font-semibold lg:text-4xl text-3xl lg:leading-9 leading-7 text-gray-800 mt-4">{oneproduct.productname}</h2>
                    ...
                    <p className=" font-normal text-base leading-6 text-gray-600 mt-7">{oneproduct.description}</p>
                    <p className=" font-semibold lg:text-2xl text-xl lg:leading-6 leading-5 mt-6 "> ₹ {oneproduct.price}</p>
                  ...
                  <Link to={"/cart"}> <button className="focus:outline-none focus:ring-2 hover:bg-black focus:ring-offset-2 focus:ring-gray-800 font-medium text-base leading-4 text-white bg-gray-800 w-full py-5 lg:mt-12 mt-6">Add to cart bag</button></Link>
                </div>
                ...
                <div className=" w-full sm:w-96 md:w-8/12  lg:w-6/12 flex lg:flex-row flex-col lg:gap-8 sm:gap-6 gap-4">
                    <div className=" w-full lg:w-8/12 bg-gray-100 flex justify-center items-center">
                        <img className='h-auto' src={oneproduct.image} alt="Wooden Chair Previw" />
                    </div>
