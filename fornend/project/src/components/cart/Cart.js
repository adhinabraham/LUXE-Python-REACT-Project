  ...
  return (
    <div>
         <div>
                    ...
                    <div className="w-full h-full bg-white  top-0 overflow-y-auto overflow-x-hidden fixed sticky-0" id="chec-div">
                            ...
                            <div className="flex md:flex-row flex-col justify-end" id="cart">
                                <div className="lg:w-1/2 w-full md:pl-10 pl-4 pr-10 md:pr-4 md:py-12 py-8 bg-white overflow-y-auto overflow-x-hidden h-screen" id="scroll">
                                    <div className="flex items-center text-gray-500 hover:text-gray-600 cursor-pointer" >
                                        ...
                                        <p className="text-sm pl-2 leading-none" onClick={()=>{navigate('/')}}>Back</p>
                                    </div>
                                ...
                                <div className="xl:w-1/2 md:w-1/3 xl:w-1/4 w-full bg-gray-100 h-full">
                                    <div className="flex flex-col md:h-screen px-14 py-20 justify-between overflow-y-auto">
                                        ...
                                        <div>
                                            ...
                                            <button onClick="" className="text-base leading-none w-full py-5 bg-gray-800 border-gray-800 border focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 text-white">
                                                Checkout
                                            </button>
                                        </div>
                                    </div>
